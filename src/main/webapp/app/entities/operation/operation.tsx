  ...
  return (
    <div>
      <h2 id="operation-heading">
        <Translate contentKey="jhipsterSampleApplicationApp.operation.home.title">Operations</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterSampleApplicationApp.operation.home.createLabel">Create new Operation</Translate>
        </Link>
      </h2>
          ...
          {operationList && operationList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('date')}>
                    <Translate contentKey="jhipsterSampleApplicationApp.operation.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <th className="hand" onClick={sort('amount')}>
                    <Translate contentKey="jhipsterSampleApplicationApp.operation.amount">Amount</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="jhipsterSampleApplicationApp.operation.home.notFound">No Operations found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
