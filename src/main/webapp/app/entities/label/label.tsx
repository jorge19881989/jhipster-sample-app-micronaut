...
export const Label = (props: ILabelProps) => {
  ...
  return (
    <div>
      <h2 id="label-heading">
        <Translate contentKey="jhipsterSampleApplicationApp.label.home.title">Labels</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterSampleApplicationApp.label.home.createLabel">Create new Label</Translate>
        </Link>
      </h2>
        ...
        {labelList && labelList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.label.label">Label</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplicationApp.label.home.notFound">No Labels found</Translate>
            </div>
          )
        )}
      </div>
