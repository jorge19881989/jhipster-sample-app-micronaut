  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.bankAccount.home.createOrEditLabel">
            <Translate contentKey="jhipsterSampleApplicationApp.bankAccount.home.createOrEditLabel">Create or edit a BankAccount</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : bankAccountEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="bank-account-user" type="select" className="form-control" name="user.id">
                  <option value="" key="0" />
                  {users
