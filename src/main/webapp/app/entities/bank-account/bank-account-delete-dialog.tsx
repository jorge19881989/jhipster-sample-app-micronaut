...
export const BankAccountDeleteDialog = (props: IBankAccountDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.bankAccount.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.bankAccount.delete.question" interpolate={{ id: bankAccountEntity.id }}>
