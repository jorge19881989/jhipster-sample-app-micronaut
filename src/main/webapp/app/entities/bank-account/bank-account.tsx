  ...
  return (
    <div>
      <h2 id="bank-account-heading">
        <Translate contentKey="jhipsterSampleApplicationApp.bankAccount.home.title">Bank Accounts</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterSampleApplicationApp.bankAccount.home.createLabel">Create new Bank Account</Translate>
        </Link>
      </h2>
        ...
        {bankAccountList && bankAccountList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.bankAccount.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.bankAccount.balance">Balance</Translate>
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.bankAccount.user">User</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplicationApp.bankAccount.home.notFound">No Bank Accounts found</Translate>
            </div>
          )
        )}
      </div>
